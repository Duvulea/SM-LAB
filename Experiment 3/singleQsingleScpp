...
int main()
{
    ...
    cout<<"Enter Arrival time and Service time :\n";
    ...
    cout<<"\n\n1) The average waiting time per customer :  "<<ans1;
    cout<<"\n2) The probability of a customer to wait in the queue:  "<<ans2;
    cout<<"\n3) The proportion of idle time for servers: "<<ans3;
    cout<<"\n4) The average service time:  "<<ans4;
    cout<<"\n5) The average arrival time:  "<<ans5;
    cout<<"\n6) The average time that a customer has to spend in the system :  "<<ans6;
    cout<<"\n";
    return 0;
}
